...
class Usuario{
	...
	//Metodos CRUD
	public function addUsuario($cuenta, $clave, $id_rol){
        $hash = MD5($clave);
        $sql = "INSERT INTO usuario(id_usuario, cuenta, clave, id_rol)VALUES(
            NULL, '{$cuenta}', '{$hash}', '{$id_rol}')";
    ...
    public function editUsuario($id_usuario, $cuenta, $clave, $rol){
        $hash = md5($clave);
        $sql = "UPDATE usuario SET cuenta='{$cuenta}', clave='{$hash}', id_rol='{$rol}'
